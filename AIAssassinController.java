...
public class AIAssassinController extends Controller 
{
	private MafiaGame currentGame;
	private ArrayList<Player> allies;
	private ArrayList<Player> enemies;
	public AIAssassinController (MafiaGame g)
	{
	...
	public void addAllies()
	{
		...
		{
			if(currentGame.getPlayerList().get(i).getRole().getRoleName().equals("Assassin"))
			{
	...
	{
		Assassin.Kill(enemies.get((int)(Math.random()*enemies.size())));
		return 0;
	}
	@Override
