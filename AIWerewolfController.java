...
public class AIWerewolfController extends Controller {

	private MafiaGame currentGame;
	private ArrayList<Player> allies;
	private ArrayList<Player> enemies;
	public AIWerewolfController (MafiaGame g)
	{
	...
	public void addAllies()
	{
		...
		{
			if(currentGame.getPlayerList().get(i).getRole().getRoleName().equals("Werewolf"))
			{
	...
	{
		Werewolf.Kill(enemies.get((int)(Math.random()*enemies.size())));
		return 0;
	}
	@Override
