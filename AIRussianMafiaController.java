...
public class AIRussianMafiaController extends Controller
{
	private MafiaGame currentGame;
	private ArrayList<Player> allies;
	private ArrayList<Player> enemies;
	public AIRussianMafiaController (MafiaGame g)
	{
	...
	public void addAllies() 
	{
		...
		{
			if(currentGame.getPlayerList().get(i).getRole().getRoleName().equals("Russian Mafia"))
			{
	...
	{
		RussianMafia.Kill(enemies.get((int)(Math.random()*enemies.size())));
		return 0;
	}
