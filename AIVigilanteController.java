...
public class AIVigilanteController extends Controller 
{
	...
	public AIVigilanteController(MafiaGame g)
	{
		this.currentGame = g;
	...
	@Override
	public int doNightBehavior() // kills random people not on the allies list
	{
		
		Vigilante.Kill(notAllies.get((int)(Math.random()*notAllies.size())));
		return 0;
